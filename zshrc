# instal zsh: https://phoenixnap.com/kb/install-zsh-ubuntu
# just need one turtial
#  next time , you can use the https://yadm.io/docs/bootstrap# :   YADM
...
# Set name of the theme to load --- if set to "random", it 
...
# 显示 Conda 环境名称
# export PROMPT='%F{yellow}(%n)%F{green}%(!.%{3}.)%F{blue}%c%F{red}$(conda info --envs | grep -E "base|^active" | sed -n "/active/s/.* #\([^ ]*\) .*/[\1]/p")%f %# '
